...
const vi = {
  ...
  frequencyRate: '{rate} lượt / triệu từ · {count} lượt trong kho ngữ liệu',
  frequencyUnavailable: 'Không có dữ liệu tần suất cho cụm từ này',
...
const en: Record<StringKey, string> = {
  ...
  frequencyRate: '{rate} / million words · {count} corpus occurrences',
  frequencyUnavailable: 'No frequency data for this phrase',
  example: 'Example',
